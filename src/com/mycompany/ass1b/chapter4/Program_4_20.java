...
System.out.print( "Enter the number of overtime hours Jon Smith worked " ); //prompt for user input
...
System.out.print( "Enter the number of regular hours worked Betty Jones Worked "); // prompt for user input
hours = input.nextDouble();
